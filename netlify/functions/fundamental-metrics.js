exports.handler = async function(event, context) {
  console.log('🚀 Netlify Function: fundamental-metrics started');
  ...
  try {
    ...
    console.log(`📊 Fetching fundamental metrics for ${coinName} (${coinSymbol})`);
...
Provide only factual, verifiable data. Use "N/A" for any metrics that cannot be reliably determined.`;
    ...
    console.log('✅ Perplexity fundamental metrics completed successfully');
